...
Работает стабильно на официальном Tampermonkey (расширение в AppStore платное), но копирование нескольких вложений за раз не работает. Расширение для юзерскриптов Safari Userscripts (quoid/userscripts) также не поддерживается из-за ограничений api.
